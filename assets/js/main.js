...
function checkForMatch() {
 ...
 function moveCounter(){ //moves counter increase by one for each match
    moves++;
...
function countCounter() { //count the matches
    count++;
    counter2.innerHTML = count;
}

function congrats() { //congrats modal display when matches = 8
    if (count == 8) {
...
function restart() {  // reloads the page to reset all things
    location.reload();
    return false;
